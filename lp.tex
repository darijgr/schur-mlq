...
%TCIDATA{LastRevised=Monday, July 30, 2018 00:45:50}
...
& =\left(  \prod_{i=1}^{k}x_{s_{i}}\right)  \det\left(  \left(  h_{\lambda
_{j}-j+i-1}\left(  x_{1},x_{2},\ldots,x_{s_{j}}\right)  \right)  _{1\leq i\leq
...
Before we can prove Theorem \ref{thm:determinant_form}, we introduce further notations.
