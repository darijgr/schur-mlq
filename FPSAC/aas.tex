...
\begin{remark}
The BB reductions always has $q_1(u) = q_1(u_{i \leftrightarrow j})$.
\end{remark}
...
%\end{tikzpicture}
%\]
%\caption{A balanced interval in $C_1$, together with an input word $u = \dotsm 2211222212 \dotsm$.}
%\end{figure}
...
\acknowledgements{
We thank Atsuo Kuniba for explaining the results in his papers~\cite{KMO15,KMO16}.
