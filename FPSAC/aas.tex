...
\begin{cor}
\label{co:merge}
  Let $\mm$ be a packed type with $m_{i+1} \neq 0$ and $\mm' = (m_1, \dotsc, m_{i-1}, m_i + m_{i+1}, m_{i+2}, \ldots)$.
...
\end{tikzpicture}
\]
\Travis{What is this an example for? The previous corollary (and example)?}
\end{example}
