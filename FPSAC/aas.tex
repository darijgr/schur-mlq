...
We note that Theorem~\ref{thm:permutation} for the special case of $x_1 = \cdots = x_n = 1$\travis{This is correct, right?} is proven in~\cite{AAMP} using different techniques.
...
In~\cite{AasLin17}, a formula for the amplitude $\swt{u \sigma_S}$ is conjectured, where $u \sigma_S = u_{\sigma_S(1)} \cdots u_{\sigma_S(r)}$.
