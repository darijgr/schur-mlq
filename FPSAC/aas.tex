...
Now, let $V_S = \RR^{\mcW_S}$ be the vector space whose basis vectors are indexed by the words in $\mcW_S$ and let $M_S \colon V_S \to V_S$ be the transition matrix of the TASEP on $\mcW_S$.
