...
\darij{What is $\ell$? Still the index of the last nonzero entry of $\mm$?}
\end{dfn}
...
\label{thm:determinant_form}
  ...
  Let $v_1v_2 \dotsm v_k$ \travis{Do not use $\dots$ (dots command)! It can get it wrong as it does here!} be a weakly decreasing (non-cyclic) packed word of length $k$ with $r-1$ classes.
