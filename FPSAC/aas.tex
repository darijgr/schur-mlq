...
Building on \cite{AAMP}, we think of queues (and MLQs in general) as functions on words of a fixed length $n$.
...
h_0(b_1) & h_0(b_2) & h_{-1}(b_3) & h_{-1}(b_4) \\
h_1(b_1) & h_1(b_2) & h_0(b_3) & h_0(b_4) \\
h_2(b_1) & h_2(b_2) & h_1(b_3) & h_1(b_4) \\
h_3(b_1) & h_3(b_2) & h_2(b_3) & h_2(b_4) \\
\end{array}\right| = x_2x_4x_5^2 + x_3x_4x_5^2+x_2x_3x_5^2+x_2x_3x_4x_5$ for $B=\{1,3,4,5\}$?
Then the formula should be $\swt{u}=\prod_{i\in B} x_i \det(h_{i-j-1+\gamma_j}(b_j))_{1\leq i,j\leq r}$.
...
In~\cite{AAMP} a more algebraic approach is used for computing the stationary probabilities\travis{This belongs \emph{only} in the introduction.}.
