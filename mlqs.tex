...
To ease notation, for every permutation $\tau \in \SymGp{r}$, we will consider its one-line notation as the word $u$ as given in Theorem~\ref{thm:determinant_form} with $v = \tau$.
...
We now prove a special weight version of this conjecture.
