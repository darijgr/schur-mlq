...
\[
\begin{tikzpicture}[>=latex,rounded corners,scale=1.2,baseline=0]
\def\passwidth{3pt};
\node (i1) at (1,1) {$3$};
\node (i2) at (2,1) {$4$};
\node (i3) at (3,1) {$6$};
...
\begin{example}
Consider $q$ from Example~\ref{ex:first_queue} and $v = 345513321$ (this is the word $u$ in Example~\ref{ex:first_queue} but replacing $6 \mapsto 5$):
\[
\begin{tikzpicture}[baseline=10]
  \def\ll{0.65}   % level 2
  \foreach \i in {5,9} { \node at (\i,\ll) {$1$}; }
...
\end{tikzpicture}
\]
Consider $u = 456613321$, and note that $v = \merge{3} u$ and
\[
\begin{tikzpicture}[baseline=10]
  \def\ll{0.65}   % level 2
  \foreach \i in {5,9} { \node at (\i,\ll) {$1$}; }
...
\end{tikzpicture}
\]
where we have $266344511 = \merge{4} 277345611$.
Also, consider $u' = 456613421$, and note that $v = \merge{3} u'$ and
\[
\begin{tikzpicture}[baseline=10]
  \def\ll{0.65}   % level 2
  \foreach \i in {5,9} { \node at (\i,\ll) {$1$}; }
...
\end{tikzpicture}
\]
where we have $266344511 = \merge{5} 277355611$.
\end{example}
