...
\erik{Give the Hasse diagram of previous example.}
...
\Travis{Darij, can you check about the sided-ness of this action? It should act on positions of the word (moving them around).}
