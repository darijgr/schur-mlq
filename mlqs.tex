...
\Darij{Why do we NEED to show this? I thought we were just proving Theorem~\ref{thm:permutation}.}
...
\darij{Judging by the definition of $\inter(i, j)$, we have $\inter(i, i) = \varnothing$ (and $\inter[i,i] = \set{i}$).
Are we sure that this is always what's intended, even in those rare cases where everything is balanced?
(I think this breaks in the $r = s$ case.)}
