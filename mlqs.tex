...
Furthermore, the type $\widetilde{\mm}$ of $\widetilde{u}$ is $\widetilde{m}_i = 1$ for $i \leq r$ and $\widetilde{m}_r = m_k$.
...
Thus, given disjoint $r$-paths $\{ \rho_i \}_{i=1}^r$ with corresponding MLQ $\widetilde{\qq} = (\widetilde{q}_1, \dotsc, \widetilde{q}_r)$, we construct $\qq = (q_1, \dotsc, q_{\ell-1})$ by
\[
...
This then forms the disjoint $r$-paths $\{\rho_i\}_{i=1}^r$ by
\begin{align*}
\rho_i \colon (0,i) \to (a_{i,K(i)},i) & \to (a_{i,K(i)},i+1) \to (a_{i,K(i)+1},i+1) \to
