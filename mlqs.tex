...
In other words, every balanced interval of $C$ are exactly the balanced intervals of $C^*$ but have been reflected around the middle of $\ive{n}$.
In addition, we have
\[
...
Consider a MLQ $\qq = \tup{q_1, q_2, \dotsc, q_k}$, then we define an action of $\SymGp{k}$ with simple transpositions $\fraks_i$ by
\[
\fraks_i \qq = \tup{q_1, \dotsc, q_{i-1}, q'_i, q'_{i+1}, q_{i+1}, \dotsc, q_k},
\]
...
\begin{proof}
\darij{TODO!}
Our proof will use~\cite[Ch.~5, (5.6.3)]{Loth}.
