...
Fix a positive integer $n$. For a nonnegative integer $k$, let $\ive{k}$ denote the set $\set{1, 2, \ldots, k}$ and $\SymGp{k}$ denote the symmetric group on $\ive{k}$.
...
We refer the reader to \cite[\S 2]{GesVie89} for details on the LGV Lemma. (The version we shall use is \cite[Corollary 2]{GesVie89}.)
