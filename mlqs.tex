...
``wrap around'' the circle), the interval $\inter[u, v]$
...
The same, of course, holds for the intervals $\inter[u, v]$
...
\Travis{Just a comment for us for now. This bracketing rule is just the usual signature rule on crystals and the $s_i$ action is the corresponding Weyl group action.}
