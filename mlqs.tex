...
\newcommand{\emptybracetabthree}{$\left\{ \begin{tabular}{c} \vphantom{s}\\ \vphantom{s}\\ \vphantom{s} \end{tabular} \right.$}
\newcommand{\emptybracetabfour}{$\left\{ \begin{tabular}{c} \vphantom{s}\\ \vphantom{s}\\ \vphantom{s}\\ \vphantom{s} \end{tabular} \right.$}
\newcommand{\emptybracetabfive}{$\left\{ \begin{tabular}{c} \vphantom{s}\\ \vphantom{s}\\ \vphantom{s}\\ \vphantom{s}\\ \vphantom{s} \end{tabular} \right.$}
