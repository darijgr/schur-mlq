...
We visualize them as points on a line which ``wraps around'' cyclically; thus, for examples, the sites weakly to the right of a site $i$ are $i, i+1, \ldots, n-1, n, 1, 2, 3, \ldots$ (in this order).
