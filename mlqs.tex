...
We now shall state a crucial result, which follows from the Lindstr\"om--Gessel--Viennot lemma and exists in the folklore\travis{This is poorly phrased, but otherwise Darij, the footnote as currently stated makes it seems like we are just avoiding a proof. We should try to make this better.
[Darij: Well, we are, and so is everyone. This is known as ``folklore''. I don't see how it shames us, seeing that we are giving a detailed reference.]}:\footnote{
...
\Darij{TODO: Example. More precisely, counterexamples, showing how each condition is actually needed.}
