...
\begin{tikzpicture}
  ...
  \node[circle,fill=white,draw=black,text=darkred,inner sep=1pt] at (2,3) {$A_3$};
  \node[circle,fill=white,draw=black,text=darkred,inner sep=1pt] at (3,1) {$A_2$};
  \node[circle,fill=white,draw=black,text=darkred,inner sep=1pt] at (5,1) {$A_1$};
...
\end{tikzpicture}
\]
\caption{A NILP from the $3$-vertex $\tup{A_1, A_2, A_3}$ to the $3$-vertex $\tup{B_1, B_2, B_3}$ of weight $x_1 x_2 x_3 x_4^2$.
