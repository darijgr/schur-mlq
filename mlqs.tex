...
See Figure~\ref{fig:tableau_to_NILP} for an example of the bijection between semistandard tableaux and NILPs used in the proof of Theorem~\ref{thm.tableau.jt}.
...
\begin{tikzpicture}[baseline=3.5cm]
  ...
  \node[circle,fill=white,draw=black,text=black,inner sep=1pt] (B4) at (1+4-4,5) {$B_4$};
  \node[circle,fill=black,inner sep=1.5pt] (B4p) at (1+4-4-1,5) {};
  ...
  \node[circle,fill=white,draw=black,text=black,inner sep=1pt] (B1) at (3+4-1,4) {$B_1$};
  \node[circle,fill=black,inner sep=1.5pt] (B1p) at (3+4-1-1,4) {};
  ...
  \begin{scope}[thick,>=stealth,brown]
      ...
      \draw[color=black] (0.4,5) node[anchor=south] {$x_5$};
  \end{scope}
  \begin{scope}[thick,>=stealth,red]
      % $p_3$:
      \draw (A3) edge[->] (1,2);
  ...
  \begin{scope}[thick,>=stealth,dgreencolor]
      ...
      \draw (5,2) edge[->] (5,3);
      \draw (5,2.5) node[anchor=east] {$1$};
      \draw (5,3) edge[->] (B1p);
      \draw (5,3.5) node[anchor=east] {$1$};
      \draw (B1p) edge[->,color=black] (B1);
      \draw[color=black] (5.4,4) node[anchor=south] {$x_4$};
  \end{scope}
  
\end{tikzpicture}
\]
\caption{A semistandard tableaux of surface $(4,3,5,5)$ (left) and the corresponding NILP (right).
