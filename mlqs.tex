...
Consider $u = 2312$.
We have the following MLQs $\qq$ (of type $\tup{1,2,0,0,0,\ldots}$) such that $\qq(1111) = 2312$:
\[
...
and we construct the corresponding $\sigma$-twisted MLQs $\qq$ (of type $\tup{1,2,0,0,0,\ldots}$)
\[
\begin{tikzpicture}[baseline=-30]
  \def\ll{0.75}   % level scaling
