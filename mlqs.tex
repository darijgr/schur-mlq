...
%In this paper we assign weights to \emph{multiline queues}, and generalize some known properties of these objects. Using these weights, we found a combinatorial proof of the Commutativity Conjecture of [AAMP]. We also extend and prove a conjecture by~\cite{AasLin17}.
%To be written last.
