...
\item[Phase I]
  ...
  (The order in which equal letters are processed does not matter, as a simple argument shows.)
...
\item[Phase I']
  ...
  (Again, the order in which equal letters are processed does not matter.)
