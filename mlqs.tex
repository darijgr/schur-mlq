...
Then,
\[
\sum_{\pp \in N(\uu,\vv)} \wt(\pp) = \det\left( \sum_{p \in N(A_i,B_j)} \wt(p) \right)_{1 \leq i,j \leq k}.
\]
\end{prop}
...
Then,
\[
\sum_{\pp \in N(\uu,\vv)} \wt(\pp) = \det\left(  \sum_{p\in N(A_i,B_j) } \wt(p) \right)_{1\leq i,\leq k} .
\]
...
Then,
\[
\sum_{T \in \SST(\lambda, s)} \wt(T) = \left(  \prod_{i=1}^{k} x_{s_i} \right)  \det\left(  h_{\lambda_j-j+i-1}(  x_1,x_2,\ldots,x_{s_j})  \right)_{1\leq i,j \leq k} .
\]
\end{thm}
...
\begin{split}
\sum_{\pp \in N(\uu,\vv)} \wt(\pp) & = \det\left(  \sum_{p \in  N(A_i,B_j)}\wt(p) \right)_{1\leq i,j \leq k} \\
& = \det\left( h_{\lambda_j-j+i-1}(x_1, x_2, \dotsc, x_{s_j}) \right)_{1\leq i,j \leq k},
\end{split}
\end{equation}
...
&  = \left(  \prod_{i=1}^k x_{s_i} \right)  \det\left( h_{\lambda_j-j+i-1}(x_1, x_2, \dotsc, x_{s_j}) \right)_{1\leq i,j \leq k}
\end{align*}
...
Then
\[
\swt{u} = \left(  \prod_{b \in B} x_b \right)  \det \left(  h_{\gamma_j+i-j-1}(x_1,\dotsc,x_{b_j}) \right)_{1 \leq i,j \leq r}.
\]
\end{thm}
...
&  = \left(  \prod_{i=1}^k x_{b_i} \right) \det\biggl( h_{\lambda_j-j+i-1}\left(x_1,x_2,\ldots,x_{b_j}\right)  \biggr)_{1\leq i,j \leq k} ,
%& \\ & = \left( \prod_{b \in B} x_b \right)  \det\left(  h_{\gamma_j+i-j-1}(x_1,\dotsc,x_{b_j}) \right)_{1\leq i,j \leq r} ,
\end{align*}
